...
bids=$root_dir"bids/mouse/"
script_dir=$root_dir"/tmp_rabies_scripts_mouse"
output_dir=$root_dir"/output_mouse"
template_dir="/home/traaffneu/joagra/code/awake/assets/template/mouse"
...
prep_arg='--commonspace_resampling 0.2x0.2x0.2 --anatomical_resampling 0.2x0.2x0.2 --detect_dummy --oblique2card 3dWarp --commonspace_reg masking=false,brain_extraction=false,template_registration=SyN,fast_commonspace=true --anat_template '${template_dir}'/template.nii.gz --brain_mask '${template_dir}'/mask.nii.gz --WM_mask '${template_dir}'/wm.nii.gz --CSF_mask '${template_dir}'/csf.nii.gz --vascular_mask '${template_dir}'/csf.nii.gz --TR ' 
