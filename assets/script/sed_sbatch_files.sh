...
dir=/project/4180000.36/awake/rat_scripts/
cd $dir
...
sed -i 's/--labels \/home\/traaffneu\/joagra\/code\/awake\/assets\/template\/rat\/labels.nii.gz //g' $file
...
sed -i 's/vpm_r.nii.gz/vpm_r.nii.gz --ROI_labels_file \/home\/traaffneu\/joagra\/code\/awake\/assets\/template\/rat\/labels.nii.gz --FC_matrix --prior_maps \/home\/traaffneu\/joagra\/code\/awake\/assets\/template\/rat\/ica.nii.gz --DR_ICA --prior_bold_idx 1 2 --prior_confound_idx 3 4/ g' $file
