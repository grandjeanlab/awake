...
def chi2_continuous(chi2_table, cat1, cat2, rodent):
...
df_to_plot = split_continuous(df, 's1.cat.gsr3', 'fd.mean')
df_to_plot = df_to_plot.rename({'s1.cat.gsr3':'value', 'quartiles':'variable'})
ax = makestackplot(df_to_plot)
plt.savefig("../assets/plot/"+rodent+"_gsr3_fd.svg")
...
cat1='s1.cat.gsr3'
cat2 = 'fd.mean'
chi2_continuous(split_continuous(df, cat1, cat2), cat1, cat2, rodent)
cat2 = 's1.gsrcov.l.gsr3'
chi2_continuous(split_continuous(df, cat1, cat2), cat1, cat2, rodent)
cat2 = 's1.tsnr.l'
chi2_continuous(split_continuous(df, cat1, cat2), cat1, cat2, rodent)
