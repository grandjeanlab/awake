...
#figure3ce
  ...
  ax = sns.barplot(x=df_to_plot[cat2],y=df_to_plot['len'],hue=df_to_plot['cat'], order=['short','long'])
...
#figure3df
  ...
  ax = sns.barplot(x=df_to_plot[cat2],y=df_to_plot['len'],hue=df_to_plot['cat'], order=['y','n'])
...
#figure3gi
  ...
  df_to_plot = df.select('cat',cat2).drop_nulls().group_by(['cat',cat2]).agg(pl.len()).sort(by=cat2).with_columns((pl.col('len') / pl.col('len').sum().over('cat')).alias('rel_count')).sort(by='cat')
  plt.figure(figsize=(5,10))
  ax = sns.barplot(x=df_to_plot[cat2],y=df_to_plot['len'],hue=df_to_plot['cat'], order=['f','m'])
...
#figure3hj
  ...
  df_to_plot = df.select('cat',cat2).drop_nulls().group_by(['cat',cat2]).agg(pl.len()).sort(by=cat2).with_columns((pl.col('len') / pl.col('len').sum().over('cat')).alias('rel_count')).sort(by='cat')
  plt.figure(figsize=(5,10))
  ax = sns.barplot(x=df_to_plot[cat2],y=df_to_plot['len'],hue=df_to_plot['cat'], order=['GE-EPI','SE-EPI'])
