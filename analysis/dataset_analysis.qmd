...
#get the number of dropped frames for each dataset and denoising method,
...
print("dropped frames using method 2")
for i in np.unique(df["rodent.ds"]):
  print("total and relative dropped frames for dataset "+str(i))
  print(df[df["rodent.ds"]==i]["dropped.frames.gsr2"].mean())
  print(df[df["rodent.ds"]==i]["dropped.frames.gsr2"].mean()/df[df["rodent.ds"]==i]["total.frames"].mean())
...
#put the values in df_summary for later use
...
df["s1.cat.aCompCor1"].value_counts(normalize=True).reindex(cat_index, fill_value=0)
for i in np.unique(df["rodent.ds"]):
  print("dataset "+str(i))
  print(df[df["rodent.ds"]==i]["s1.cat.aCompCor1"].value_counts(normalize=True).reindex(cat_index, fill_value=0))

df["s1.cat.aCompCor2"].value_counts(normalize=True).reindex(cat_index, fill_value=0)
for i in np.unique(df["rodent.ds"]):
  print("dataset "+str(i))
  print(df[df["rodent.ds"]==i]["s1.cat.aCompCor2"].value_counts(normalize=True).reindex(cat_index, fill_value=0))

df["s1.cat.aCompCor3"].value_counts(normalize=True).reindex(cat_index, fill_value=0)
for i in np.unique(df["rodent.ds"]):
  print("dataset "+str(i))
  print(df[df["rodent.ds"]==i]["s1.cat.aCompCor3"].value_counts(normalize=True).reindex(cat_index, fill_value=0))


df["s1.cat.gsr1"].value_counts(normalize=True).reindex(cat_index, fill_value=0)
for i in np.unique(df["rodent.ds"]):
  print("dataset "+str(i))
  print(df[df["rodent.ds"]==i]["s1.cat.gsr1"].value_counts(normalize=True).reindex(cat_index, fill_value=0))

df["s1.cat.gsr2"].value_counts(normalize=True).reindex(cat_index, fill_value=0)
for i in np.unique(df["rodent.ds"]):
  print("dataset "+str(i))
  print(df[df["rodent.ds"]==i]["s1.cat.gsr2"].value_counts(normalize=True).reindex(cat_index, fill_value=0))

df["s1.cat.gsr3"].value_counts(normalize=True).reindex(cat_index, fill_value=0)
for i in np.unique(df["rodent.ds"]):
  print("dataset "+str(i))
...
for analysis in analysis_list:
  df_summary.join(df.groupby("rodent.ds")["s1.cat."+analysis].apply(lambda x: return_cat_index(x, analysis, cat_index)).droplevel(1), on='rodent.ds')


df_summary.to_csv("../assets/tables/"+rodent+"_summary_fc.tsv", sep="\t", index=False)
...
plt.savefig("../assess/figure/"+rodent+"_denoise_specificity_svg")
...
for analysis in analysis_list:
  ...
  plt.savefig("../assets/figure/"+rodent+"_fc_specificity_"+analysis+".svg")
